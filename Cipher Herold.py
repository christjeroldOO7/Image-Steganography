...
image_icon=PhotoImage(file="Logo/Cipher Herold.png")
root.iconphoto(False,image_icon)

#===================Logo=======================

logo=PhotoImage(file="Logo/BG.png")
Label(root,image=logo,bg="#2E4053").place(x=20,y=20)
Label(root,text="Image Encryption & Decryption",bg="#2E4053",fg="white",font="Helvetica 25 bold").place(x=100,y=20)
...
f2=Frame(root,bd=3,bg="black",width=340,height=240,relief=SUNKEN)
f2.place(x=350,y=100)
txt1=Text(f2,font="Akzidenz-Grotesk 18 ",bg="black",fg="White",relief=SUNKEN,wrap=WORD)
...
f3=Frame(root,bd=3,bg="#2E4053",width=330,height=110,relief=GROOVE)
f3.place(x=15,y=360)
...
Label(f3,text="Img,Doc File..",bg="#2E4053",fg="white").place(x=20,y=5)

#=================Fourth frame======================


f4=Frame(root,bd=3,bg="#2E4053",width=330,height=110,relief=GROOVE)
...
Label(f4,text="Options available..",bg="#2E4053",fg="white").place(x=20,y=5)
